...
let TorrentController = class TorrentController {
    ...
    downloadTorrent(downloadTorrentInput, user) {
        return this.torrentService.donwloadTorrent(downloadTorrentInput, user);
    }
};
__decorate([
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.DOWNLOADER),
...
], TorrentController.prototype, "downloadTorrent", null);
